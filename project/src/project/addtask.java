...
public class addtask extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel2);
        jLabel2.setBounds(110, 80, 90, 25);

        jLabel3.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("ADD TASK");
        jPanel2.add(jLabel3);
        jLabel3.setBounds(110, 190, 86, 25);
        ...
        jScrollPane1.setBounds(110, 230, 332, 96);
        ...
        jPanel2.add(jLabel4);
        jLabel4.setBounds(200, 130, 30, 16);
        ...
        jButton1.setBounds(510, 10, 50, 40);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            String hrs= jTextField4.getText();
            String mins=jTextField3.getText();
            ...
            if(hrs1>12 || hrs1<0 || mins1>60 || mins1<0){
                JOptionPane.showMessageDialog(null,"Invalid Time");
            }
            else{
            String insert="INSERT INTO project VALUES('"+hrs+"','"+mins+"','"+code+"','"+task+"')";
